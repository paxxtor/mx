$(document).ready(function() {
    ...
    // table for procceedings and folders 
    $('#pf').DataTable({
        "paging":   true,
        "ordering": false,
        "orderable": false,
        ...
        "info":     false,
         ...
         "lengthMenu": "_MENU_",
           "paginate": {
            ...
            $('#t_acctions_length').css({
                'display': 'flex'
            });
            $('#t_acctions_length').append(`
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle" type="button" id="filterDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding-left:10px !important;align-self: center;color: white;">
                    <i class="fa fa-filter"></i> 
                </button> 
                    ...
                    if (column.index() == 7) {
                        ...
                        column
                            ...
                            .each(function(d, j) {
                                ...
                                select.find('select').append('<option value="' + $(d).text() + '">' + $(d).text() + '</option>');
