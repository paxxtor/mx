(function($){
    $.fn.filetree = function(method){
                ...
                return this.each(function(){
                    ...
                    $fileList
                        ...
                        .has('ul') // Any li that has a list inside is a folder root
                            .addClass('open')
                            .on('click', 'div[class="files"]', function(e){ // Add a click override for the folder root links
                                e.preventDefault();
        ...
        $(".folder-root").mouseenter(function() {
            $(this).find(".folder-actions").css({
                display: "block"
            });
        });
        
        $(".folder-root").mouseleave(function() {
            $(this).find(".folder-actions").css({
                display: "none"
            });
        });
