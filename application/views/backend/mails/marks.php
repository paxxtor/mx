...
<div width="100%" style="background: #39a2d9; padding: 0px; line-height:28px; height:100%;  width: 100%; color: #606060; ">
  ...
  <div style="vertical-align: top; padding-bottom:50px;padding-top:50px;border-bottom: 1px solid rgba(0, 0, 0, 0.1);background: #001b3d;" align="center"><a href="#"><img src="<?php echo base_url();?>uploads/<?php echo $this->db->get_where('settings', array('type' => 'logow'))->row()->description;?>" alt="<?php echo $system_name;?>" style="border:none;max-width:75%"></a></div>
    <div style="padding: 40px; background: #fff; overflow-x:auto;">
      <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
        <tbody>
          <tr>
            <td><b><?php echo get_phrase('student');?>:</b> <?php echo $student_name;?></td>
          </tr>
          <tr>
            <td><b><?php echo get_phrase('student_marksheet_are_there');?>:</b></td>
          </tr>
          <tr><td><br></td></tr>
          <tr>
            <td>
                  <table style="width:100%;border: 1px solid black;">
                    <tr>
                      <th style="border: 1px solid black;text-align: left;padding:10px;"><?php echo get_phrase('subject');?></th>
                      <th style="border: 1px solid black;text-align: left;padding:10px;"><?php echo get_phrase('teacher');?></th>
                      <th style="border: 1px solid black;text-align: left;padding:10px;"><?php echo get_phrase('mark');?></th>
                      <th style="border: 1px solid black;text-align: left;padding:10px;"><?php echo get_phrase('comment');?></th>
                    </tr>
                    <?php 
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid black;padding:10px;"><?php echo $this->crud_model->get_name('teacher', $row3['teacher_id']); ?></td>
