...
<div class="page-body">
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3>Agregar <?php echo $this->db->get_where('directory_rol',array('directory_rol_id'=>$type))->row()->name;?></h3>
                </div>
                <div class="col-12 col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>"> <i data-feather="home"></i></a></li>
                        <li class="breadcrumb-item"><?php echo $this->db->get_where('directory_rol',array('directory_rol_id'=>$type))->row()->name;?></li>
                        <li class="breadcrumb-item active"> Agregar <?php echo $this->db->get_where('directory_rol',array('directory_rol_id'=>$type))->row()->name;?></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="edit-profile">
            <div class="row">
                <div class="col-xl-12">
                    <form class="card needs-validation" action="<?php echo base_url(); ?>admin/directory/add/<?php echo $type; ?>" method="post" enctype='multipart/form-data' novalidate="">
                        ...
                        <div class="card-body">
                            <div style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'flex';?>">
                                <div class="col-sm-12">
                                    <hr>
                                    <div class="middles">
                                        <label>
                                            <input type="radio" id="fisic_type" value="0" name="directory_type" checked="">
                                            <div class="front-end box">
                                                <span>Física</span>
                                            </div>
                                        </label>
                                        <label>
                                            <input type="radio" id="moral_type" value="1" name="directory_type">
                            ...
                            <div class="row" id="fisica">
                                <div class="col-sm-12 col-md-12" style="text-align: center;">
                                    <div class="mb-3 mt-3">
                                        <h4 style="background: #001A15;padding: 7px;border-radius: 10px;color: #fff;">DATOS <?php echo (!in_array($type,array(9,6,7,8,11)))?'PERSONA FÍSICA':'';?></h4>
                                    </div>
                                </div>
                                <div class="row col-md-12 profile-title">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label"><?php echo (!in_array($type,array(9,6,7,8,11)))?'Primer apellido':'Referencia';?></label>
                                            <input class="form-control" type="text" name="first_last_name">
                                        </div>
                                        <div class="mb-3" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                            <label class="form-label">Segundo Apelldio</label>
                                            <input class="form-control" type="text" name="second_last_name">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-3" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect9">Identificación Oficial:</label><span style="color:red">*</span>
                                        <select class="form-select mb3 typehead" data-table="io_oficial" name="io_oficial">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-3" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="frc">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-3" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-12 col-md-12 mb-3" style="height: 30px;text-align: center;display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                    ...
                                    <div class=" text-end" style="top: -43px;position: relative;">
                                        <label class="switch">
                                            <input type="checkbox" onclick="switchDiv('en_su_caso')"><span class="switch-state"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6  en_su_caso" style="display:none">
                                    <div class="mb-3 ">
                                ...
                                <div class="col-sm-12 col-md-6  en_su_caso" style="display:none">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="date" name="expire_passport">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                ...
                                <div class="col-sm-12 col-md-12    mb-3" style="text-align: center;height: 30px;">
                                    <div class="">
                                        ...
                                        <div class=" text-end" style="top: -43px;position: relative;">
                                            <label class="switch">
                                                <input type="checkbox" onclick="switchDiv('individual_address')"><span class="switch-state"></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 row individual_address" style="display:none">
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="no_extern">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">No. Interior</label>
                                            <input class="form-control" type="text" name="no_intern">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="c_p">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Entidad Federativa</label>
                                            <input class="form-control" type="text" name="federity_entity">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 mb-3" style="text-align: center;height: 30px;">
                                    <div class="mb-3 ">
                                        ...
                                        <div class=" text-end" style="top: -43px;position: relative;">
                                            <label class="switch">
                                                <input type="checkbox" onclick="switchDiv('individual_email_phone')"><span class="switch-state"></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 row individual_email_phone" style="display:none;">
                                    <div class="col-sm-12 col-md-4">
                                        <div class="mb-3">
                                ...
                                <div class="col-sm-12 col-md-12 mb-3" style="height: 30px;text-align: center;display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                    <div class=" ">
                                        ...
                                        <div class=" text-end" style="top: -43px;position: relative;">
                                            <label class="switch">
                                                <input type="checkbox" onclick="switchDiv('individual_represntative')"><span class="switch-state"></span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 row individual_represntative" style="display:none">
                                    <div class="col-md-12" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="mb-3">
                                            <label class="form-label">Nombre(s)</label>
                                            <input class="form-control" type="text" name="name_representative">
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="mb-3">
                                            <label class="form-label">Primer Apelldio</label>
                                            <input class="form-control" type="text" name="first_last_name_representative">
                                        </div>
                                    </div>
                                    <div class="col-md-6" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="mb-3">
                                            <label class="form-label">Segundo Apelldio</label>
                                            <input class="form-control" type="text" name="second_last_name_representative">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-sm-12 col-md-3" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="mb-3">
                                            <label class="form-label">Número/Folio</label>
                                            <input class="form-control" type="text" name="folio_representative">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="mb-3">
                                            <label class="form-label">Registro Federal de Contribuyente(RFC)</label>
                                            <input class="form-control" type="text" name="frc_representative">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="mb-3">
                                            <label class="form-label">Clave Única de Registro de Población(CURP)</label>
                                            <input class="form-control" type="text" name="curp_representative">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="mb-3">
                                            <label class="form-label" for="exampleFormControlSelect9">Nacionalidad:</label><span style="color:red">*</span>
                                    ...
                                    <div class="col-sm-12 col-md-6" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                        <div class="col-sm-12 col-md-12" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                            <div class="mb-3">
                                                <label class="form-label" for="exampleFormControlSelect9">Documento con el que acredita la situación migratoria y estancia legal en el país:<span style="color:red">*</span></label>
                                        ...
                                        <div class="col-sm-12 col-md-12" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                            <div class="mb-3">
                                                <label class="form-label">Fecha de vencimiento</label>
                                                <input class="form-control" type="date" name="expire_passport_representative">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-12" style="display:<?php echo ($type == 9 || $type == 6 || $type == 7 || $type == 8 || $type == 11)?'none':'block';?>">
                                            <div class="mb-3">
                            ...
                            <div class="row" id="moral" style="display:none">
                                ...
                                <div class="row col-md-12 profile-title">
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="name_moral">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Registro Federal de Contribuyentes (RFC)</label>
                                            <input class="form-control" type="text" name="frc_moral">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 mb-3" style="text-align: center;height: 30px;">
                                ...
                                <div class="col-sm-12 col-md-12 row acta_constitutiva" style="display:none">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="notary_name">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Municipio Demarcaion Territorial del Notario ó Corredor Público que lo expide</label>
                                            <input class="form-control" type="text" name="notary_municipality">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Número de Notario ó Correduría</label>
                                            <input class="form-control" type="text" name="notary_number">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Entidad Federativa</label>
                                            <input class="form-control" type="text" name="notary_entity">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12" style="text-align: center;">
                                        <div class="mb-3 mt-3">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="folio_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Entidad Federativa</label>
                                            <input class="form-control" type="text" name="folio_entity">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 mb-3" style="text-align: center;height: 30px;">
                                ...
                                <div class="col-sm-12 col-md-12 row moral_representative" style="display:none">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Nombre(s)</label>
                                            <input class="form-control" type="text" name="name_representative_moral">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Primer Apelldio</label>
                                            <input class="form-control" type="text" name="first_last_name_representative_moral">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Segundo Apelldio</label>
                                            <input class="form-control" type="text" name="second_last_name_representative_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">Identificación Oficial</label>
                                            <input class="form-control" type="text" name="dni_representative_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">Número/Folio</label>
                                            <input class="form-control" type="text" name="folio_representative_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">Registro Federal de Contribuyente(RFC)</label>
                                            <input class="form-control" type="text" name="frc_representative_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">Clave Única de Registro de Población(CURP)</label>
                                            <input class="form-control" type="text" name="curp_representative_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                ...
                                <div class="col-sm-12 col-md-12 row moral_docs" style="display:none">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" name="doc_notary_power">
                                ...
                                <div class="col-sm-12 col-md-12 row moral_address" style="display:none">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Calle</label>
                                            <input class="form-control" type="text" name="street_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">No. Exterior</label>
                                            <input class="form-control" type="text" Exterior" name="no_extern_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">No. Interior</label>
                                            <input class="form-control" type="text" Interior" name="no_intern_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label">Colonia</label>
                                            <input class="form-control" type="text" name="colony_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Demarcación Territorial o Municipio</label>
                                            <input class="form-control" type="text" name="municipality_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">C.P.</label>
                                            <input class="form-control" type="text" name="c_p_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Entidad Federativa</label>
                                            <input class="form-control" type="text" name="federity_entity_moral">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-12 mb-3" style="text-align: center;height: 30px;">
                                ...
                                <div class="col-sm-12 col-md-12 row moral_correo" style="display:none">
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">Facebook</label>
                                            <input class="form-control" type="text" name="facebook_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">Instagram</label>
                                            <input class="form-control" type="text" name="instagram_moral">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">twitter</label>
                                            <input class="form-control" type="text" name="twitter_moral">
                                        </div>
                                    </div>
                                </div>
                            </div>
