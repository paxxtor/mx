            ...
            <div class="media">
                <div class="media-body align-self-center">
                    <a href="social-app.html">
                        <h3 class="user-name2">Carpetas Judiciales </h3>
                    </a>
                </div>
            </div> 
         </div>
        <div class="post-body"> 
            <div class="table-responsive">
                <table class="table table-padded dataTable no-footer show-case">
                    ...
                    <tbody>
                        <?php $folders = $this->db->order_by('folder_id','DESC')->get_where('folder',array('type'=>2,'status'=>1,'manager_id'=>$directory_id))->result_array(); 
