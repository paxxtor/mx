<div class="card">
    <div class="profile-post">
        <div class="post-header">
            ...
            <a style="float:right" class="btn btn-primary mb-3" onclick="modalRequest('<?php echo base_url();?>modal/popup/modal_new_economic_move/<?php echo $folder_id;?>/folder');" href="javascript:void(0)">+ </a>
                ...
                <table class="table table-padded dataTable no-footer show-case">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $proceeding_in = $this->db->get_where('movment_economic',array('origin_id'=>$folder_id,'origin'=>'folder','status'=>1))->result_array();
            ...
            if (movment_economic_id != "") {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        getDetails('proceeding_economic', <?php echo $folder_id; ?>);
