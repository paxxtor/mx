...
<div class="page-body">
    ...
    <a class="floated-chat-btn " style="text-decoration: none;" href="<?php echo base_url();?>admin/add_invoice/<?php echo base64_encode($action_type); ?>"><i class="icofont icofont-plus"></i></a>
                ...
                <div class="card">
                    <div class="social-tab">
                        <ul class="nav nav-tabs" id="top-tab" role="tablist">
                            <li class="nav-item"><a href="<?php echo base_url();?>admin/client_invoice" class="nav-link <?php  if($status == "") echo 'active'; ?>"><i class="fa fa-users"></i>Todos</a></li>
                            <li class="nav-item"><a href="<?php echo base_url();?>admin/client_invoice/1" class="nav-link <?php  if($status == 1) echo 'active'; ?>"><i class="fa fa-money"></i>Cobrados </a></li>
                            <li class="nav-item"><a href="<?php echo base_url();?>admin/client_invoice/2" class="nav-link <?php  if($status == 2) echo 'active'; ?>"><i class="fa fa-clock-o"></i>Pendientes</a></li>
                            <li class="nav-item"><a href="<?php echo base_url();?>admin/client_invoice/3" class="nav-link <?php  if($status == 3) echo 'active'; ?>"><i class="fa fa-calendar"></i>Vencidos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card-header pb-0" style="align-self: center;display:flex;">
                    ...
                    <div class="col-sm-12 " style="text-align: center;display:flex;">
                        <div style="margin:10px 25px;color:green">
                            <h3><?php echo $this->crud_model->getCurrency().$this->crud_model->get_total_invoice(0); ?></h3>
                            <p style="font-weight:bold">TOTAL COBRADO</p>
                        </div>
                        <div style="margin:10px 25px;;">
                            <h3><?php echo $this->crud_model->getCurrency().$this->crud_model->get_pending_invoice(0); ?></h3>
                            <p style="font-weight:bold">PENDIENTE DE COBRO</p>
                        </div>
                        <div style="margin:10px 25px;;color:red">
                            <h3><?php echo $this->crud_model->getCurrency().$this->crud_model->get_expire_invoice(0); ?></h3>
                        ...
                        <table class="table table-padded dataTable no-footer " id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="font-size:20px" onclick="modalLgRequest('<?php echo base_url();?>modal/popup/modal_invoice_pay/<?php echo $row['invoice_id'];?>');" href="javascript:void(0)"><i class="fa fa-file-text"></i></a>
                                        &nbsp
                                        <a style="font-size:20px;color:#00B8E9" href="<?php echo base_url();?>admin/edit_invoice/<?php echo base64_encode( $row['invoice_id']); ?>"><i class="fa fa-pencil-square"></i></a>
                                        &nbsp
