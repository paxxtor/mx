...
<form class="row" action="<?php echo base_url(); ?>admin/proceeding_files/add" method="post" id="idForm" enctype="multipart/form-data">
    ...
    <div class="col-sm-12 col-md-4 mb-3">
        <label class="form-label" ><b>Fecha de publicación:</b></label><span style="color:red">*</span>
        <input class="form-control"  type="date" name="publication_date" required>
    </div>
    <div class="col-sm-12 col-md-4 mb-3">
        <label class="form-label" ><b>Fecha de inicio de terminó:</b>
        <input class="form-control"  type="date" name="date_start_end" >
    </div>
    <div class="col-sm-12 col-md-4 mb-3">
        <label class="form-label" ><b>Fecha terminó:</b>
    ...
    <div class="text-right mt-3" style="text-align: right;">
        <br>
        <button class="btn-primary" type="submit" id="modal_save">Guardar</button>
    </div>
</form>
