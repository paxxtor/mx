<form action="<?php echo base_url(); ?>admin/contact_profile/add_personal" method="post" id="idForm">
    ...
    <div class="col-sm-12 col-md-12 mb-3">
        <div class="mb-3">
            ...
            <select class="form-select mb3 typehead" data-table="charge" name="charge" required>
                <option value=""></option>
            </select>
        </div>
    </div>
    <div class="text-right mt-3" style="text-align: right;">
        <br>
        <button class="btn btn-success" type="submit" id="modal_save">Guardar</button>
    </div>
</form>
<script>
    ...
    $("#idForm").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#modal1').modal('hide');
                getDetails('personal', <?php echo $param2; ?>);
