            ...
            <div class="media">
                <div class="media-body align-self-center">
                    <a href="social-app.html">
                        <h3 class="user-name2">Juzgados </h3>
                    </a>
                </div>
            </div>

            <a style="float:right" class="btn btn-primary mb-3" onclick="modalRequest('<?php echo base_url();?>modal/popup/modal_add_judged/<?php echo $proceeding_id;?>');" href="javascript:void(0)">+ </a>
        </div>
        <div class="post-body">
