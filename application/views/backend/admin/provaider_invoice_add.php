        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3 style="  text-transform: uppercase;">Agregar factura de proviciones</h3>
                </div>
                <div class="col-12 col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>"> <i data-feather="home"></i></a></li>
                        <li class="breadcrumb-item">Factura de proviciones</li>
                        <li class="breadcrumb-item active"> Agregar factura de proviciones</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="email-body">
                                    <div class="email-compose">
                                        ...
                                        <div class="email-wrapper" style="padding:20px 20%;">
                                            <form class="theme-form" action="<?php echo base_url(); ?>admin/provisions_invoice/create" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12 col-md-12 ">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select js-example-basic-single" name="proceeding_id">
                                                            ...
                                                            <option value="<?php echo $mg['proceeding_id'] ?>"><?php echo $mg['code']?></option>
                                                            <?php endforeach;  ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" cols="10" rows="2" name="observation"></textarea>
                                                </div>
