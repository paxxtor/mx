<form action="<?php echo base_url(); ?>admin/proceeding_judged/add" method="post" id="idForm">
    ...
    <div class="col-sm-12 col-md-12 mb-3">
        <div class="mb-3">
            ...
            <select class="form-select js-example-basic-single" required name="directory_id" id="users_holders">
                <?php  $managers = $this->db->where('directory_rol_id',9)->get('directory')->result_array();
    ...
    <div class="text-right mt-3" style="text-align: right;">
        <br>
        <button class="btn " type="submit" id="modal_save">Guardar</button>
    </div>
</form>
<script>
    ...
    $("#idForm").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#modal1').modal('hide');
                getDetails('proceeding_judged', <?php echo $param2; ?>);
