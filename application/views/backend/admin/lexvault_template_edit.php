                ...
                <div>
                    <div style="text-align:left;">
                        <h3 class="user-name2 " style="display: inline-flex;">
                            <a href="<?php echo base_url(); ?>admin/lexvault_templates">
                    ...
                    <div class="" id="mydiv">
                        ...
                        <a class="toolbar_icons" style="cursor:pointer; width: 20px;padding:5px" title="Word" href="<?php echo base_url(); ?>admin/lexvault_template_edit/downloadWord/<?php echo $lexvault_template_id; ?>"><img src='data:image/svg+xml,%3Csvg xmlns="http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg" width="20" height="20" viewBox="0 0 48 48"%3E%3Cg fill="none" stroke-linejoin="round" stroke-width="4"%3E%3Cpath fill="%232F88FF" stroke="%23000" d="M10 4H30L40 14V42C40 43.1046 39.1046 44 38 44H10C8.89543 44 8 43.1046 8 42V6C8 4.89543 8.89543 4 10 4Z"%2F%3E%3Cpath stroke="%23fff" stroke-linecap="round" d="M16.0083 20L19.0083 34L24.0083 24L29.0083 34L32.0083 20"%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E' /></a>
                        <a class="toolbar_icons" style="cursor:pointer; width: 20px;padding:5px" target="_blank" title="PDF" href="<?php echo base_url(); ?>admin/lexvault_template_edit/downloadPDF/<?php echo $lexvault_template_id; ?>"><img src='data:image/svg+xml,%3Csvg xmlns="http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg" width="20" height="20" viewBox="0 0 48 48"%3E%3Cg fill="none" stroke="%23000" stroke-width="4"%3E%3Cpath stroke-linecap="round" stroke-linejoin="round" d="M10 38V44H38V38"%2F%3E%3Cpath stroke-linecap="round" stroke-linejoin="round" d="M38 20V14L30 4H10V20"%2F%3E%3Cpath stroke-linecap="round" stroke-linejoin="round" d="M28 4V14H38"%2F%3E%3Crect width="40" height="18" x="4" y="20" stroke-linejoin="round" rx="2"%2F%3E%3Cpath stroke-linecap="round" d="M21 25V33"%2F%3E%3Cpath stroke-linecap="round" d="M10 25V33"%2F%3E%3Cpath stroke-linecap="round" stroke-linejoin="round" d="M32 33V25H37"%2F%3E%3Cpath stroke-linecap="round" stroke-linejoin="round" d="M32 30H37"%2F%3E%3Cpath stroke-linecap="round" stroke-linejoin="round" d="M10 25H13.5C14.8807 25 16 26.1193 16 27.5V27.5C16 28.8807 14.8807 30 13.5 30H10"%2F%3E%3Cpath stroke-linecap="round" stroke-linejoin="round" d="M21 25H23C25.2091 25 27 26.7909 27 29V29C27 31.2091 25.2091 33 23 33H21"%2F%3E%3Cpath stroke-linecap="round" d="M16 12H20"%2F%3E%3C%2Fg%3E%3C%2Fsvg%3E' /></a>
                            ...
                            <div class="todo-list-body" id="fields_list">
                                ...
                                ?>
                                    <li class="task m-b-10">
                                        <span class="task-label ">[<?php echo $field; ?>]</span><span class="task-action-btn" style="color: red;margin-left: 10px;"><span class="action-box large delete-btn" title="Delete Task" onclick="deleteField('<?php echo $key; ?>')"><i class="icon"><i class="icon-trash"></i></i></span></span>
                                    </li>
                                    <?php endforeach; ?>
...
$(function() {
    ...
    $("#add_field").click(function() {
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>admin/lexvault_template_edit/add_fiels/<?php echo $lexvault_template_id; ?>',
            data: {
                'field': $('#new_field').val(),
            },
...
function deleteField(sValue) {
    $.ajax({
        type: "POST",
        url: '<?php echo base_url(); ?>admin/lexvault_template_edit/delete_field/<?php echo $lexvault_template_id; ?>',
        data: {
            'field': sValue,
        },
        success: function(data) {
...
function saveContent() {
    ...
    $.ajax({
        type: "POST",
        url: '<?php echo base_url(); ?>admin/lexvault_template_edit/save_content',
        data: {
            'content': contenido,
