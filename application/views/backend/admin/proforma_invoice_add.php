        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3 style="  text-transform: uppercase;">Agregar factura proforma</h3>
                </div>
                <div class="col-12 col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>"> <i data-feather="home"></i></a></li>
                        <li class="breadcrumb-item">Factura proforma</li>
                        <li class="breadcrumb-item active"> Agregar factura proforma</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="email-body">
                                    <div class="email-compose">
                                        ...
                                        <div class="email-wrapper" style="padding:20px 20%;">
                                            <form class="theme-form" action="<?php echo base_url(); ?>admin/proforma_invoice/create" method="POST" enctype="multipart/form-data">
