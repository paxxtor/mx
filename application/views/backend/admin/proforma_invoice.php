...
<div class="page-body">
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3>FACTURA PROFORMAS</h3>
                </div>
                <div class="col-12 col-sm-6">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url()?>"> <i data-feather="home"></i></a></li>
                        <li class="breadcrumb-item">Cobro a clientes</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <a class="floated-chat-btn " style="text-decoration: none;" href="<?php echo base_url();?>admin/invoice_add/<?php echo base64_encode($action_type); ?>"><i class="icofont icofont-plus"></i></a>
                ...
                <div class="card">
                    <div class="social-tab">
                        <ul class="nav nav-tabs" id="top-tab" role="tablist">
                            <li class="nav-item"><a href="<?php echo base_url();?>admin/proforma_invoice" class="nav-link <?php  if($status == "") echo 'active'; ?>"><i class="fa fa-users"></i>Todos</a></li>
                            <li class="nav-item"><a href="<?php echo base_url();?>admin/proforma_invoice/1" class="nav-link <?php  if($status == 1) echo 'active'; ?>"><i class="fa fa-money"></i>Cobrados </a></li>
                            <li class="nav-item"><a href="<?php echo base_url();?>admin/proforma_invoice/2" class="nav-link <?php  if($status == 2) echo 'active'; ?>"><i class="fa fa-clock-o"></i>Pendientes</a></li>
                            <li class="nav-item"><a href="<?php echo base_url();?>admin/proforma_invoice/3" class="nav-link <?php  if($status == 3) echo 'active'; ?>"><i class="fa fa-calendar"></i>Vencidos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-padded dataTable no-footer " id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="font-size:20px" onclick="modalLgRequest('<?php echo base_url();?>modal/popup/modal_proforma_invoice_pay/<?php echo $row['invoice_id'];?>');" href="javascript:void(0)"><i class="fa fa-file-text"></i></a>
                                        &nbsp
                                        <a style="font-size:20px;color:#00B8E9" href="<?php echo base_url();?>admin/proforma_invoice_edit/<?php echo base64_encode( $row['invoice_id']); ?>"><i class="fa fa-pencil-square"></i></a>
                                        &nbsp
