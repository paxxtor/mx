            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="javascript:void(0)"><span><b><?php echo $this->account_model->getUserFullName('admin',$this->session->userdata('login_user_id'));?></b></span></a></li>
                        <li><a href="<?php echo base_url();?>admin/admin_profile/<?php echo base64_encode($this->session->userdata('login_user_id')); ?>"><i data-feather="users"></i><span>Mi perfil</span></a></li>
